...
+
image::rh-sso/find_operator.png[]

. Click btn:[Install]
+
image::rh-sso/operator_install_button.png[]

. Select a Project to install the Operator into
+
image::rh-sso/operator_project_selection.png[]
+
[NOTE]
====
...
image::rh-sso/project_creation.png[]
====

. Click btn:[Install]
+
image::rh-sso/operator_complete_install.png[]

. Wait for Operator install to complete

. Once the Operator has installed click btn:[View Operator]
+
image::rh-sso/operator_installed.png[]
...
+
image::aap/installed_operators.png[]

.. Select the RH-SSO project
+
image::rh-sso/select_project.png[]

.. Click on Red Hat Single Sign-On Operator
+
image::rh-sso/rh-sso_operator.png[]

. On the RH-SSO Operator *Details* page click btn:[Create Instance] on the *Keycloak* tile
+
image::rh-sso/keycloak_instance.png[]

. Click btn:[YAML view]
+
image::rh-sso/keycloak_instance_yaml_view.png[]
...
. Click btn:[Create]
+
image::rh-sso/keycloak_instance_create.png[]

. Wait for Keycloak Instance creation to complete
+
image::rh-sso/keycloak_instance_completed.png[]
+
[NOTE]
====
...
+
image::rh-sso/keycloak_realm_listing.png[]

. Click btn:[Create KeycloakRealm]
+
image::rh-sso/keycloak_realm_create_button.png[]

. If not already selected click btn:[YAML view]
+
image::rh-sso/keycloak_realm_yaml_view.png[]
...
+
image::rh-sso/keycloak_realm_create_realm.png[]

. Wait for the realm creation to complete
+
image::rh-sso/keycloak_realm_created.png[]
...
+
image::rh-sso/keycloak_client_listing.png[]

. Click btn:[Create KeycloakClient]
+
image::rh-sso/keycloak_client_create_button.png[]

. If not already selected click btn[YAML view]
+
image::rh-sso/keycloak_client_yaml_view.png[]
...
+
image::rh-sso/keycloak_client_create_client.png[]
...
+
image::rh-sso/keycloak_user.png[]

. Click btn:[Create KeycloakUser]
+
image::rh-sso/keycloak_user_create.png[]

. If not already selected click btn[YAML view]
+
image::rh-sso/keycloak_user_yaml.png[]
...
. Click btn:[Create]
+
image::rh-sso/keycloak_user_create_button.png[]
...
image::aap/project_creation.png[]
====

. Click btn:[Install]
+
image::aap/operator_complete_install.png[]

. Wait for Operator install to complete

. Once the Operator has installed click btn:[View Operator]
+
image::aap/operator_installed.png[]
...
+
image::aap/keycloak_public_key.png[]
...
+
image::aap/ocp_secret_menu.png[]

.. Select menu:Project[ansible-automation-platform]
+
image::aap/ocp_secret_project.png[]

.. Click menu:Create[From YAML]
+
image::aap/ocp_secret_create_yaml.png[]
...
.. Click btn:[Create]
+
image::aap/ocp_secret_create.png[]
...
+
image::aap/aap_operator.png[]

. Select Automation Hub
+
image::aap/aap_operator_hub.png[]

. Click btn:[Create AutomationHub]
+
image::aap/hub_create_instance.png[]

. Click btn:[YAML view]
+
image::aap/hub_instance_yaml_view.png[]
...
. Click btn:[Create]
+
image::aap/hub_instance_create.png[]

. Wait for the instance creation to complete
+
image::aap/hub_instance_created.png[]
...
+
image::rh-sso/keycloak_client_ah.png[]

. Select YAML
+
image::rh-sso/keycloak_client_ah_yaml.png[]
...
====
+
image::rh-sso/keycloak_client_ah_update_yaml.png[]

. Click btn:[Save]
+
image::rh-sso/keycloak_client_ah_update_yaml_save.png[]
